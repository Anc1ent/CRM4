...
<div style="padding:00px; background-color:#ffffff;">
    <div>
        ...
        <div id="FavoritesButton" onclick="show_drivers_tableFav('<?=base_url()?>', $(this), '<?=$quote->id?>')" style="float:left; background-color:#80ACD1; color:#ffffff; text-align:center; padding:10px; padding-left:20px; padding-right:20px; font-size:14px; cursor:pointer; font-weight:bold;  ">FAVORITES</div>
    ...
    <table class="insideTableWhiteGrey" border="0" style="width:100%;" cellpadding="0" cellspacing="0">
        <tr class="head" style="background-color:#80ACD1; color:#ffffff;">
            ...
            <td style="padding-left:20px; width:150px;">Company Name</td>
            <td style="width:120px;">Phone</td>
            <td style="width:70px;">Email</td>
            <td style="width:70px;">Date Added</td>
        ...
        foreach($drivers as $item){
            ...
            <tr style="cursor:pointer;" class="contentRow DriversRow">
                ...
                <td style="text-align:left; font-size:12px; width:70px;">
                    <?=date('d/m/y', strtotime($item->datetime));?><br/>
                    <?=date('h:i A', strtotime($item->datetime));?>
