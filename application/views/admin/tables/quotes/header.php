...
<ul class="QuotesTable" style="width:100%;">
  ...
  <div class="cell" style="width:4%;">
     ...
     <div class="cell" style=" width:11%; cursor:pointer;">
       <span style="font-size:8px; display:inline-block; margin-top:-3px; padding-right:5px;"><?php if($iSORT == 'id') if($S=="ASC"){?>▲<?php }else{ ?>▼<?php } ?></span><span onclick="chTableSort('<?=base_url()?>', '<?php if($S=="ASC"){?>1<?php }else{ ?>0<?php } ?>', 'id');" style="cursor:pointer;">ID</span> <span style="font-size:8px; display:inline-block; margin-top:-3px; padding-right:2px; padding-left:7px;"><?php if($iSORT == 'emailsSent') if($S=="ASC"){?>▲<?php }else{ ?>▼<?php } ?></span> <span onclick="chTableSort('<?=base_url()?>', '<?php if($S=="ASC"){?>1<?php }else{ ?>0<?php } ?>', 'emailsSent');" style="font-size:10px; cursor:pointer;">S</span>
       <span style="font-size:8px; display:inline-block; margin-top:-3px; padding-right:2px; padding-left:3px;"><?php if($iSORT == 'emailsOpened') if($S=="ASC"){?>▲<?php }else{ ?>▼<?php } ?></span> <span onclick="chTableSort('<?=base_url()?>', '<?php if($S=="ASC"){?>1<?php }else{ ?>0<?php } ?>', 'emailsOpened');" style="font-size:10px; cursor:pointer;">O</span>
       <span style="font-size:8px; display:inline-block; margin-top:-3px; padding-right:2px; padding-left:3px;"><?php if($iSORT == 'emailsRecived') if($S=="ASC"){?>▲<?php }else{ ?>▼<?php } ?></span> <span onclick="chTableSort('<?=base_url()?>', '<?php if($S=="ASC"){?>1<?php }else{ ?>0<?php } ?>', 'emailsRecived');" style="font-size:10px; cursor:pointer;">R</span> 
    </div>
