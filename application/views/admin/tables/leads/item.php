<li onclick="activateQuote('<?=base_url()?>','<?=$data->id?>', 0);" id="q-<?=$data->id?>" class="itemQT  <?=$OddClass?>"  >
  <div class="cell" style="width:4%;">
    ...
    <div class="cell" style=" width:10%;">
       <div >
       <?php if($data->price != 0){ ?> $ <?php } ?><span  id="priceVal<?=$data->id?>" ><?php if($data->price == 0){ echo "<span style='color:#ff5050; font-weight:bold;'>NONE</span>"; }else{ echo ($data->price + $data->deposit); } ?></span></div>
