  ...
  <div class="cell" style="width:4%;">
   ...
   <div class="cell" style=" width:11%; font-size:11px;">
    ...
    <div style="clear:both;"></div>
      ...
      <li class="SlideDownTableItems" style="display:none; width:100%; border-top:none; border-left:none; border-bottom:solid dashed #24567A;" id="bookit<?=$data->id?>" >
        <div  class="backEmailsList" style="background-color:transparent;">
          <div id="bookitBlock<?=$data->id?>" style="display:none; ">
